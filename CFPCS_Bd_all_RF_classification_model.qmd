...
####RF Model 4 (-longitude, -external/combination tissues only) REDUCED MODEL SET (WITHOUT LONGITUDE OR INTERNAL-ONLY TISSUE SAMPLES)
...
mtry2_Bdp <- tuneRF(train_ds_Bdp[-1]
                    , Bdpt
                    , ntreeTry = 500
                    , stepFactor = 1.5
                    , improve = 0.01
...
for (i in 1:100) {
  ...
  #construct random forest object
   RF_model <- randomForest(as.factor(Status_Bd)~.
                  ...
                  , importance=T
                  , strata = as.factor(pred_samp[,"Status_Bd"])
                  , sampsize = c(155, 155) #subsample at similar rates to what we find in nature
...
ConfMatrix <- confusionMatrix(predict(RF_model, test_ds_Bdp), test_ds_Bdp$Status_Bd, positive = '1')
ConfMatrix
# Confusion Matrix and Statistics
# 
#           Reference
...
#declare training datasets for both classes
Bd0=RF_Bdp.1.exto[RF_Bdp.1.exto$Status_Bd=="0",] #379
Bd1=RF_Bdp.1.exto[RF_Bdp.1.exto$Status_Bd=="1",] #142
